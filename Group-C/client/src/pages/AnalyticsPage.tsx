        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50 hover:bg-gray-50">
              ...
              <TableHead>Shout-outs</TableHead>
          ...
          <TableBody>
            {users.map((user) => (
              <TableRow key={user.id}>
                ...
                <TableCell className="text-gray-600">{user.shouts}</TableCell>
                <TableCell>
                  <Badge variant="outline" className="border-green-200 bg-green-50 text-green-700" style={{ borderRadius: 'var(--radius-sm)' }}>
                    {user.status}
                  </Badge>
                ...
                <TableCell>
                  <Button variant="ghost" size="icon" className="w-8 h-8" style={{ borderRadius: 'var(--radius-md)' }}>
