...
const StatsCards = ({ stats }) => {
  // If no stats provided, default to empty or loading state, or 0 values
  const defaultStats = [
    { label: 'Shout-outs Sent', value: stats?.total_shoutouts || 0 },
    { label: 'Reactions Received', value: stats?.total_reactions || 0 },
    { label: 'Comments Made', value: stats?.total_comments || 0 }
  ];
