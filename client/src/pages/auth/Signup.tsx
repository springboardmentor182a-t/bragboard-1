  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to BragBoard Admin!",
      });
      navigate("/dashboard");
    } catch (error) {
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8 space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-indigo-200">Join BragBoard Admin Team</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2 text-white">
              <Label htmlFor="confirmPassword" className="text-indigo-100">Confirm Password</Label>
              <Input
                id="confirmPassword"
                type="password"
